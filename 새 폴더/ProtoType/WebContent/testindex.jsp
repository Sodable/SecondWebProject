...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="button-holder">
                        ...
                        <button type="button" class="btn btn-blue navbar-btn" data-toggle="modal" data-target="#회원가입">회원가입</button>
 ...
 -->               
    ...
    <div class="modal fade" id="회원가입" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
